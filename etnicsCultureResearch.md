...
Rekening houden met ethiek is tijdens het ontwikkelen van software is belangrijk. Zo moet je er rekening mee houden welke impact jouw applicatie gaat hebben op bepaalde doelgroepen of personen ook moet je er rekening mee houden met hoe groot die impact kan zijn. Ook zou je rekening kunnen houden met de manier waarop de doelgroepen de doelen en methoden van de software ontwikkelaars kunnen opvatten/begrijpen. Je moet ook respect hebben voor mensen waarmee je samenwerkt tijdens een project.
...
In mijn eigen project vraag ik ook steeds feedback aan mijn docent door middel van feedback gesprekken zodat ik regelmatig erachter kom of we nog ongeveer op zelfde lijn zitten.
...
#### Privacy
Met privacy hebben we tijdens het realiseren van onze proftaak hebben we eigenlijk niet zoveel rekening gehouden. Maar zelf vind ik het wel heel belangrijk en daarom hadden we dus samen overlegd hoe we onze applicatie zouden kunnen aanpassen:
...
Voor dit punt hadden we gekeken naar hoe we data gebruiken in onze applicatie en of we deze ethisch en transparant gebruiken.
